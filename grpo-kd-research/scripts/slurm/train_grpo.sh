#!/bin/bash
#SBATCH --job-name=grpo_faroese
#SBATCH --output=logs/grpo_faroese_%j.out
#SBATCH --error=logs/grpo_faroese_%j.err
#SBATCH --nodes=1
...
# Parse arguments
CONFIG_FILE=${1:-"configs/training/grpo_teacher_ll.yaml"}
OUTPUT_DIR=${2:-"results/grpo_teacher_ll"}
